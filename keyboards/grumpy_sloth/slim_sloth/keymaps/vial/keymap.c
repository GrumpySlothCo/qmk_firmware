...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴───┼───┴┬────┬────┤ ┌───┼───┼───┐ ├───┴───┼───┤Ent│
     * │Ctrl│GUI │Alt │                        │ Alt│RGBL│Menu│Ctrl│ │ ← │ ↓ │ → │ │   0   │ . │   │
     * └────┴────┴────┴────────────────────────┴────┴────┴────┴────┘ └───┴───┴───┘ └───────┴───┴───┘
     */
    ...
    /*
     * RGB control layer — hold Right GUI to access.
     * Nav cluster: Hue / Sat / Val  (up = increase, down = decrease)
     * Numpad:      Effect cycle, Speed, Toggle
     */
    [_RGBL] = LAYOUT_fullsize_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    RGB_HUD, RGB_SAD, RGB_VAD,    RGB_MOD, RGB_SPI, _______,  _______,
...
void keyboard_post_init_user(void) {
    // Hold Left Win while plugging in to toggle Mac / Windows mode.
    // Mac mode swaps the Alt and GUI (Option/Command) key positions and persists
    // across power cycles until toggled again.
    if (matrix_is_on(5, 6)) {
